...
/**
 * print_version - A function that print the version of an ELF header.
...
/**
 * print_osabi - A function that print the OS/ABI of an ELF header.
 * @e_ident: A pointer to an array containing the ELF version.
 */
...
/**
 * print_entry - A function that print the entry point of an ELF header.
